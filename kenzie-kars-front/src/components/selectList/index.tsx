...
export const SelectList = ({ open, setActionOverCarBrand, setActionOverCarModel, setActionOverCarColor, setActionOverCarYear, setActionOverCarFuel, arrayMap, primary, onClickButton }: ISelectProps) => {
	...
	const filterItemSelect = (primary: string, element: string) => {
		switch (primary) {
			...
			case 'Combustível': {
                const newFilterConditions = { ...filterConditions, fuel: element };
				setFilterConditions(newFilterConditions);
